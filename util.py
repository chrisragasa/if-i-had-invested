test_data_monthly = {
    "Meta Data": {
        ...
        "2. Symbol": "MSFT",
        "3. Last Refreshed": "2019-03-28 16:00:01",
...
test_data_note = { 'Note': 'Thank you for using Alpha Vantage! Our standard API call frequency is 5 calls per minute and 500 calls per day. Please visit https://www.alphavantage.co/premium/ if you would like to target a higher API call frequency.'
}
